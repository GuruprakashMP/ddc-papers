...
def work(title="Machine learning for reaction prediction",
         doi="10.1039/d0xx00001a", journal="Chemical Science"):
    return {
        "display_name": title,
...
class TestOpenAlexGuards(unittest.TestCase):
    ...
    def test_peer_review_report_dropped(self):
        w = work(title='Review for "Machine learning for reaction prediction"',
